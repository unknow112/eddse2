...
def get_abstracts_by_fos(lang: str, fos: str, prog_bar_position: int):
    # Folder paths
    ...
    write_path = join_path(dataset_path, "abstracts.jsonl")
